...
from gsapi.models import Mealdata
...
def get_html(D): #여기부터 D를 넣어주는 이유는 뒤에 날짜기 때문
    ...
    URL = (
            "http://stu.sen.go.kr/sts_sci_md01_001.do?" #망할사이트
...
if __name__ == "__main__":
    ...
    for D in week:
        for i in Dayotw:
            Mealdata(date_data = get_day(D,i+1), meal_data = get_meal(D,i)).save()
